...
import Bin from "./OSWAP_OtcPair.json";
...
export class OSWAP_OtcPair extends _Contract{
    ...
    offers: {
        (params: IOffersParams, options?: TransactionOptions): Promise<{provider:string,locked:boolean,allowAll:boolean,originalAmount:BigNumber,amount:BigNumber,swappedAmount:BigNumber,receiving:BigNumber,restrictedPrice:BigNumber,startDate:BigNumber,expire:BigNumber}>;
    }
    protocolFeeBalance0: {
        (options?: TransactionOptions): Promise<BigNumber>;
    }
    ...
    private assign(){
        ...
        let offers_call = async (params: IOffersParams, options?: TransactionOptions): Promise<{provider:string,locked:boolean,allowAll:boolean,originalAmount:BigNumber,amount:BigNumber,swappedAmount:BigNumber,receiving:BigNumber,restrictedPrice:BigNumber,startDate:BigNumber,expire:BigNumber}> => {
            ...
            return {
                ...
                originalAmount: new BigNumber(result.originalAmount),
                amount: new BigNumber(result.amount),
                swappedAmount: new BigNumber(result.swappedAmount),
        ...
        let setApprovedTrader_txData = async (params: ISetApprovedTraderParams, options?: TransactionOptions): Promise<string> => {
        ...
        let setMultipleApprovedTraders_txData = async (params: ISetMultipleApprovedTradersParams, options?: TransactionOptions): Promise<string> => {
